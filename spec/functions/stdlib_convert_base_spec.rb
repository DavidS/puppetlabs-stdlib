...
describe 'stdlib::convert_base' do
  ...
  it { is_expected.to run.with_params(['1'], '2').and_raise_error(ArgumentError, %r{'stdlib::convert_base' parameter 'number_to_convert' expects a value of type Integer or String, got Tuple}) }
  it { is_expected.to run.with_params('1', ['2']).and_raise_error(ArgumentError, %r{'stdlib::convert_base' parameter 'new_base' expects a value of type Integer or String, got Tuple}) }
